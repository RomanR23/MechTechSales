		...
		return (
			<div className="product-checkout" key={index}>
				...
				<div className="product-counter-checkout">
					<button className="product-quantity-button" onClick={() => checkoutDec(product)}>
						-
					</button>
					<div>{product.product_quantity}</div>
					<button className="product-quantity-button" onClick={() => checkoutInc(product)}>
						+
					</button>
	...
	return (
		<div className="checkout-container">
			...
			<div className="checkout-products-container">
				<div className="checkout-products">{cartArray}</div>

				<div className="checkout-price-container">
					<div className="shopping-cart-box">
						<h1 className="shopping-cart-total-h1">Shopping Cart Total</h1>
						<p>
							<b>Shipping Cost:</b> * FREE PROMO *
						</p>
					</div>
